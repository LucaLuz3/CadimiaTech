    ...
    days: [
      ...
      },
      {
        ...
        exercises: [
          ...
          { name: "Ab Rollout (roda abdominal)", sets: "3", reps: "8–12", rest: "60s", rir: "1 RIR", muscles: "Core completo, Dorsal", note: "Exercício mais eficaz para core (EMG studies)", priority: true },
        ],
      },
    ],
  },
    ...
    days: [
      {
        ...
        exercises: [
          { name: "Supino Reto com Barra", sets: "4", reps: "6–8", rest: "3 min", rir: "2 RIR", muscles: "Peitoral, Tríceps, Deltoide Ant.", note: "Prioridade #1 — composição máxima de carga", priority: true },
          ...
          { name: "Prancha Dinâmica (Body Saw)", sets: "3", reps: "12 reps", rest: "60s", rir: "—", muscles: "Core Anterior, Oblíquos", note: "Mais eficaz que prancha estática (EMG)", priority: true },
        ],
      },
      {
        ...
        exercises: [
          ...
          { name: "Crunch na Polia (Rope Crunch)", sets: "4", reps: "15–20", rest: "60s", rir: "1 RIR", muscles: "Reto Abdominal", note: "Melhor que crunch no chão — carga progressiva", priority: true },
        ],
      },
      {
        ...
        exercises: [
          ...
          { name: "Elevação de Pernas + Crunch Oblíquo", sets: "3", reps: "12 + 15 cada lado", rest: "60s", rir: "1 RIR", muscles: "Core completo", note: "Superset", priority: true },
        ],
      },
    ],
  },
